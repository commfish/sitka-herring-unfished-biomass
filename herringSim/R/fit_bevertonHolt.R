#' Fit beverton-holt stock-recruit model
#'
#' This function uses maximum likelihood to fit a beverton-holt stock-recruitment
#' model.
#'
...
#' - **mleFit:** Output from [stats4::mle()]
#'
#' @export
#'


fit_bevertonHolt <- function(recruits, spawners, start,
  ...
  mleFit <- stats4::mle(minuslogl = minuslogl, start = start, nobs = length(recruits))
